...
import { setTodoModal, setMoreModal, setEditModal, setPushModal, setTaskModal, setStorageModal } from "../../../modules/redux/action/modal";
...
const useModal = () => {
    ...
    const setState= {
        ...
        setStorageModal: (payload: boolean) => {
            dispatch(setStorageModal(payload))
        },
    }
    return {
        state, 
