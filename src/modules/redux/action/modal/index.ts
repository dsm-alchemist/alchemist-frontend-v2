...
import { SET_TODO_MODAL, SET_MORE_MODAL, SET_EDIT_MODAL, SET_PUSH_MODAL, SET_TASK_MODAL, SET_STORAGE_MODAL } from "./interface";
...
export const setStorageModal = createAction(SET_STORAGE_MODAL)<boolean>();
...
export type modalActionType =
    ...
    | ReturnType<typeof setStorageModal>;